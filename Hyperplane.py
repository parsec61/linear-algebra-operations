...
class Hyperplane(object):
    ...
    EITHER_DIM_OR_NORMAL_VEC_MUST_BE_PROVIDED_MSG = 'Either the dimension the hyperplane must be provided'
    ...
    def __eq__(self, p):
        ...
        x0 = self.basepoint
        y0 = p.basepoint
        basepoint_differance = x0.minus(y0)

        n = Vector(self.normal_vector)
        return basepoint_differance.is_orthogonal_to(n)
